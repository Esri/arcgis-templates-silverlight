...
Namespace Toolkit.Icons
  ...
  Public Class WorldGlobe
    ...
    Private world As WorldGlobe
    Private bexpandOnMouseOver As Boolean = False

    Public Sub New()
      Me.DefaultStyleKey = GetType(WorldGlobe)
    End Sub
    ...
    Public Shared ReadOnly OceanFillProperty As DependencyProperty = DependencyProperty.Register("OceanFill", GetType(Brush), GetType(WorldGlobe), New PropertyMetadata(New SolidColorBrush(Color.FromArgb(255, 193, 97, 57)), AddressOf OnOceanFillPropertyChanged))

    Private Shared Sub OnOceanFillPropertyChanged(ByVal d As DependencyObject, ByVal e As DependencyPropertyChangedEventArgs)

      Dim globe As WorldGlobe = TryCast(d, WorldGlobe)
    ...
    Public Shared ReadOnly LandFillProperty As DependencyProperty = DependencyProperty.Register("LandFill", GetType(Brush), GetType(WorldGlobe), New PropertyMetadata(New SolidColorBrush(Color.FromArgb(255, 193, 97, 57)), AddressOf OnLandFillPropertyChanged))
    ...
    Public Shared ReadOnly ExpandOnMouseOverProperty As DependencyProperty = DependencyProperty.Register("ExpandOnMouseOver", GetType(Boolean), GetType(WorldGlobe), New PropertyMetadata(False, AddressOf OnExpandOnMouseOverChanged))
    ...
    Public Shared ReadOnly ScaleProperty As DependencyProperty = DependencyProperty.Register("Scale", GetType(Double), GetType(WorldGlobe), New PropertyMetadata(1.0R, AddressOf OnScalePropertyChanged))
