...
#Region "Zoom Level"
    ...
    Private Sub SetUpZoom()
      If ZoomLevelStack IsNot Nothing Then
        ...
        Dim levelHeight As Double = (100 \ numLevels)
        For i As Integer = min To max
          Dim brush As SolidColorBrush = setLevelBrush(i)
          Dim levelBorder As New Border() With {.BorderThickness = New Thickness(1), .CornerRadius = New CornerRadius(1), .Height = levelHeight, .Width = 18, .BorderBrush = New SolidColorBrush(Color.FromArgb(255, 0, 0, 0)), .Background = brush, .Tag = i}
...
#Region "HeaderGrid Button events"
    ...
    Private Sub PanHeaderGrid_MouseLeftButtonUp(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
      If PanArrowsGrid.ActualHeight > 0 Then
        HidePanArrows.Begin()
      Else
        ShowPanArrows.Begin()
      End If
    ...
    Private Sub MapScaleHeaderGrid_MouseLeftButtonUp(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
      If MapScaleGrid.ActualHeight > 0 Then
        HideMapScale.Begin()
      Else
        ShowMapScale.Begin()
      End If
    ...
    Private Sub MapZoomHeaderGrid_MouseLeftButtonUp(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
      If MapZoomGrid.ActualHeight > 0 Then
        HideMapZoom.Begin()
      Else
        ShowMapZoom.Begin()
      End If
    ...
    Private Sub WorldGlobe_MouseLeftButtonDown(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
      If Map IsNot Nothing Then
        Map.ZoomTo(Map.Layers.GetFullExtent())
      End If
    End Sub

    Private Sub OverviewHeaderGrid_MouseLeftButtonUp(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
      If OverviewGrid.ActualHeight > 0 Then
        HideOverview.Begin()
      Else
        ShowOverview.Begin()
      End If
    ...
    Private Sub HeaderTitleHeaderGrid_MouseLeftButtonUp(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
    ...
    Private Sub ViewOptionsHeaderGrid_MouseLeftButtonUp(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
      If ViewOptionsGrid.ActualHeight > 0 Then
    ...
    Private Sub SpatialQueryHeaderGrid_MouseLeftButtonUp(ByVal sender As Object, ByVal e As MouseButtonEventArgs)
      If SpatialQueryGrid.ActualHeight > 0 Then
