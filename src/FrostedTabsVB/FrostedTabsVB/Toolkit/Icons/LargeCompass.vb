...
Namespace Toolkit.Icons
  ...
  Public Class LargeCompass
    Inherits Control
    Private compass As LargeCompass
    ...
    Public Sub New()
      Me.DefaultStyleKey = GetType(LargeCompass)
    End Sub
    ''' <summary>
    ...
    Public Overrides Sub OnApplyTemplate()
      ...
      If dblScale <> 1 Then
        compass.CompassScale.ScaleX = dblScale
        compass.CompassScale.ScaleY = dblScale
      End If
      If bexpandOnMouseOver Then
        AddHandler compass.MouseEnter, AddressOf compass_MouseEnter
        AddHandler compass.MouseLeave, AddressOf compass_MouseLeave
      End If
    ...
    Public Shared ReadOnly ScaleProperty As DependencyProperty = DependencyProperty.Register("Scale", GetType(Double), GetType(LargeCompass), New PropertyMetadata(1.0R, AddressOf OnScalePropertyChanged))

    Private Shared Sub OnScalePropertyChanged(ByVal d As DependencyObject, ByVal e As DependencyPropertyChangedEventArgs)

      Dim compass As LargeCompass = TryCast(d, LargeCompass)
    ...
    Public Shared ReadOnly ExpandOnMouseOverProperty As DependencyProperty = DependencyProperty.Register("ExpandOnMouseOver", GetType(Boolean), GetType(LargeCompass), New PropertyMetadata(False, AddressOf OnExpandOnMouseOverChanged))
    ...
    Public Shared ReadOnly FaceFillProperty As DependencyProperty = DependencyProperty.Register("FaceFill", GetType(Brush), GetType(LargeCompass), New PropertyMetadata(New SolidColorBrush(Color.FromArgb(255, 74, 119, 234)), AddressOf OnFaceFillPropertyChanged))
